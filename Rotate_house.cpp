...
void rotate()
{
    ...
    m = -h * (cos(rtheta) - 1) + k * (sin(rtheta));
    n = -k * (cos(rtheta) - 1) - h * (sin(rtheta));
    rot_mat[0][0] = cos(rtheta);
    rot_mat[0][1] = -sin(rtheta);
    rot_mat[0][2] = m;
    rot_mat[1][0] = sin(rtheta);
    rot_mat[1][1] = cos(rtheta);
    rot_mat[1][2] = n;
    rot_mat[2][0] = 0;
    rot_mat[2][1] = 0;
    rot_mat[2][2] = 1;
